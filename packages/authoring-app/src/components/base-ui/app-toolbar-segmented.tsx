...
const btn = (active: boolean, i: number, size: 'compact' | 'comfortable'): CSSProperties => ({
  ...
  ...(size === 'comfortable'
    ? { padding: '4px 14px', fontSize: 12, fontWeight: 500, textTransform: 'capitalize' as const }
    : { padding: '4px 10px', fontSize: 11, fontWeight: 600, textTransform: 'uppercase' as const, letterSpacing: '0.05em' }),
});
